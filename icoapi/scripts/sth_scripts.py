...
async def rename_sth_device(system: ICOsystem, mac_address: str, new_name: str) -> STHRenameResponseModel:
    ...
    return STHRenameResponseModel(name=new_name, mac_address=mac_address.format(), old_name=old_name)
